...
import dk.nyk.api.factories.StoreApiServiceFactory;
...
public class StoreApi  {
   ...
   public StoreApi(@Context ServletConfig servletContext) {
    ...
    @Operation(summary = "Delete purchase order by identifier.", description = "For valid response try integer IDs with value < 1000. Anything above 1000 or nonintegers will generate API errors.", tags={ "store" })
    @ApiResponses(value = { 
    ...
    public Response deleteOrder(@Parameter(in = ParameterIn.PATH, description = "ID of the order that needs to be deleted",required=true) @PathParam("orderId") Long orderId,@Context SecurityContext securityContext)
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "200", description = "Unexpected error", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Error.class))) })
    public Response getOrderById(@Parameter(in = ParameterIn.PATH, description = "ID of order that needs to be fetched",required=true) @PathParam("orderId") Long orderId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "200", description = "Unexpected error", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Error.class))) })
    public Response placeOrder(@Parameter(in = ParameterIn.DEFAULT, description = "" ) Order body
